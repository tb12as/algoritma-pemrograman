...
computer = {'telunjuk' : ['jempol'], 'kelingking' : ['telunjuk'], 'jempol' : ['kelingking']}
...
while True:
    ...
    pemain = pemain.lower()
    if pemain in jari:
        komputer = [*computer[pemain], pemain][randint(0,1)] #https://stackoverflow.com/questions/68783326/unpack-list-of-list-python
